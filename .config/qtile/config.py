...
keys = [
         ...
         Key([mod], "Return",
             # lazy.spawn(myTerm),
             lazy.spawn(r"""emacsclient -c -a 'emacs' --eval '(luklun/run-in-vterm "neofetch")'"""),
         ...
         KeyChord([mod],"e", [
             ...
             Key([], "c",
                 lazy.spawn(r"""emacsclient -c -a 'emacs' --eval '(luklun/run-in-vterm "ssh -L localhost:53000:cl:22 plugh.foi.se -l luklun")'"""),
                 desc='Loggin to workstation cl'
                 ),
             Key([], "a",
                 lazy.spawn(r"""emacsclient -c -a 'emacs' --eval '(luklun/run-in-vterm "ssh -L localhost:53010:aibks-dlpc-3:22 plugh.foi.se -l luklun")'"""),
                 desc='Loggin to workstation cl'
                 ),
         ]),
...
group_names = [("www", {'layout': 'monadtall', 'spawn': 'brave'}),
               ("dev", {'layout': 'monadtall', 'spawn': 'emacsclient -c -a emacs'}),
