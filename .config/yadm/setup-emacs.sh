...
[[ ! "$OS" == *"Microsoft"* ]] && emacs --eval "(progn (theme-magic-from-emacs) (kill-emacs))" && cp ~/.cache/wal/colors.Xresources ~/.Xresources && xrdb ~/.Xresources
# Create a soft link to the wal theme generated by rofi
[[ ! "$OS" == *"Microsoft"* ]] && ln -s $HOME/.cache/wal/rofiWalTheme.rasi $HOME/.config/rofi/rofiWalTheme.rasi
